...
C_y_alpha_rot=qt.coherent(Na,-alpha)+ 1j* qt.coherent(Na, alpha)
C_y_alpha_rot=C_y_alpha_rot/C_y_alpha_rot.norm()
final_state_T1=qt.tensor(qt.coherent(Na,alpha),C_y_alpha)
final_state_T2=qt.tensor(qt.coherent(Na,alpha),C_y_alpha_rot)
final_state=(final_state_T1+final_state_T2)
...
#fidelity
final_state=: 0.5 * ket2dm(basis(5, 4)) + 0.5 * ket2dm(basis(5, 2))