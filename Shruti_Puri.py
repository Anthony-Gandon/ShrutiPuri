...
cops = [k1_PCC**0.5*b_PCC_tensor,
        k2_PCC**0.5*(b_PCC_tensor**2-beta_inf**2),
        k2_storage**0.5*(a_s_tensor**2-alpha_inf**2)
        ]
...
res = qt.mesolve([chi0*H_inter,], qt.tensor(storage_0,PCC_0), tlist, cops,progress_bar=TextProgressBar())
print("solved")
